...
<Project Type="Project" LVVersion="23008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="image_processing" Type="Folder">
			<Item Name="calibration_07162024_-300V.ini" Type="Document" URL="../temp_images_MELEXIR/calibration_07162024_-300V.ini"/>
			<Item Name="calibration_07162024_-1000V.ini" Type="Document" URL="../temp_images_MELEXIR/calibration_07162024_-1000V.ini"/>
			<Item Name="MaxEntAbel.dll" Type="Document" URL="../temp_images_MELEXIR/MaxEntAbel.dll"/>
			<Item Name="MaxEntAbel.lib" Type="Document" URL="../temp_images_MELEXIR/MaxEntAbel.lib"/>
			<Item Name="MaxEntAbel.pdb" Type="Document" URL="../temp_images_MELEXIR/MaxEntAbel.pdb"/>
			<Item Name="Melexir.exe" Type="Document" URL="../temp_images_MELEXIR/Melexir.exe"/>
			<Item Name="Meveler.exe" Type="Document" URL="../temp_images_MELEXIR/Meveler.exe"/>
			<Item Name="PrepareVMI.exe" Type="Document" URL="../temp_images_MELEXIR/PrepareVMI.exe"/>
		</Item>
		<Item Name="main_VIs" Type="Folder">
			<Item Name="config_files" Type="Folder"/>
			<Item Name="AP2_cold_head_control.vi" Type="VI" URL="../main_VIs/AP2_cold_head_control.vi"/>
			...
			<Item Name="AP_2_pulse_control.vi" Type="VI" URL="../main_VIs/AP_2_pulse_control.vi"/>
		</Item>
		<Item Name="sub_VIs" Type="Folder">
			<Item Name="CRC" Type="Folder">
				<Item Name="CRC_calc.vi" Type="VI" URL="../sub_VIs/CRC/CRC_calc.vi"/>
			</Item>
			...
			<Item Name="Lakeshore_336" Type="Folder">
				<Item Name="get_setpoint.vi" Type="VI" URL="../sub_VIs/Lakeshore_336/get_setpoint.vi"/>
				<Item Name="get_temp_K.vi" Type="VI" URL="../sub_VIs/Lakeshore_336/get_temp_K.vi"/>
				<Item Name="go_to_user_defined_temp.vi" Type="VI" URL="../sub_VIs/Lakeshore_336/go_to_user_defined_temp.vi"/>
				<Item Name="initialise.vi" Type="VI" URL="../sub_VIs/Lakeshore_336/initialise.vi"/>
			</Item>
			<Item Name="laser_VIs" Type="Folder">
				...
				<Item Name="user_setpoint.vi" Type="VI" URL="../sub_VIs/Lakeshore_336/user_setpoint.vi"/>
			</Item>
			<Item Name="MELEXIR" Type="Folder">
				<Item Name="call_MELEXIR.vi" Type="VI" URL="../sub_VIs/MELEXIR/call_MELEXIR.vi"/>
				<Item Name="change_plot_units.vi" Type="VI" URL="../sub_VIs/MELEXIR/change_plot_units.vi"/>
				<Item Name="gen_PES_MELEXIR.vi" Type="VI" URL="../sub_VIs/MELEXIR/gen_PES_MELEXIR.vi"/>
				<Item Name="nm_eV.vi" Type="VI" URL="../sub_VIs/MELEXIR/nm_eV.vi"/>
				<Item Name="pixel_to_energy.vi" Type="VI" URL="../sub_VIs/MELEXIR/pixel_to_energy.vi"/>
				<Item Name="read_calibration_file.vi" Type="VI" URL="../sub_VIs/MELEXIR/read_calibration_file.vi"/>
			</Item>
			...
			<Item Name="oscilloscope_VIs" Type="Folder">
				...
				<Item Name="del_avg_Qs.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/del_avg_Qs.vi"/>
				<Item Name="delete_scope_data_Qs.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/delete_scope_data_Qs.vi"/>
				<Item Name="extract_avg_data.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/extract_avg_data.vi"/>
				<Item Name="find_scope_data_Q_errors.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/find_scope_data_Q_errors.vi"/>
				<Item Name="flush_avg_queues.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/flush_avg_queues.vi"/>
				<Item Name="generate_avg.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/generate_avg.vi"/>
				<Item Name="generate_RT_average.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/generate_RT_average.vi"/>
				<Item Name="generate_summed_waveform.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/generate_summed_waveform.vi"/>
				<Item Name="init_avg_scope_Qs.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/init_avg_scope_Qs.vi"/>
				<Item Name="init_scope_data_Qs.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/init_scope_data_Qs.vi"/>
				<Item Name="load_scope_config.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/load_scope_config.vi"/>
				<Item Name="measure_aquisition_time.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/measure_aquisition_time.vi"/>
				<Item Name="offset_WFm.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/offset_WFm.vi"/>
				<Item Name="prep_plotting_data.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/prep_plotting_data.vi"/>
				<Item Name="raw_Q_to_avg_Q.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/raw_Q_to_avg_Q.vi"/>
				<Item Name="real_time_trace_avg.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/real_time_trace_avg.vi"/>
				<Item Name="save_scope_config.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/save_scope_config.vi"/>
				<Item Name="save_summed_trace.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/save_summed_trace.vi"/>
				<Item Name="set_sample_rate_record_length.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/set_sample_rate_record_length.vi"/>
				<Item Name="start_scope.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/start_scope.vi"/>
				<Item Name="time_to_mass.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/time_to_mass.vi"/>
				<Item Name="write_conditions_to_scope.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/write_conditions_to_scope.vi"/>
				<Item Name="write_data_to_CSV.vi" Type="VI" URL="../sub_VIs/oscilloscope_VIs/write_data_to_CSV.vi"/>
			...
			<Item Name="PES_aquisition" Type="Folder">
				...
				<Item Name="write_PES_data.vi" Type="VI" URL="../sub_VIs/PES_aquisition/write_PES_data.vi"/>
				<Item Name="update_counts.vi" Type="VI" URL="../sub_VIs/PES_aquisition/update_counts.vi"/>
				<Item Name="radius_plot.vi" Type="VI" URL="../sub_VIs/PES_aquisition/radius_plot.vi"/>
				<Item Name="init_proc_img_Q.vi" Type="VI" URL="../sub_VIs/PES_aquisition/init_proc_img_Q.vi"/>
				<Item Name="enqueue_proc_img.vi" Type="VI" URL="../sub_VIs/PES_aquisition/enqueue_proc_img.vi"/>
				<Item Name="prep_PDS_plot.vi" Type="VI" URL="../sub_VIs/PES_aquisition/prep_PDS_plot.vi"/>
			</Item>
			<Item Name="QC9530_delay_generators" Type="Folder">
				<Item Name="calc_repeller_delay_T0.vi" Type="VI" URL="../sub_VIs/QC9530_delay_generators/calc_repeller_delay_T0.vi"/>
				<Item Name="init_box_1.vi" Type="VI" URL="../sub_VIs/QC9530_delay_generators/init_box_1.vi"/>
				<Item Name="init_box_2.vi" Type="VI" URL="../sub_VIs/QC9530_delay_generators/init_box_2.vi"/>
				<Item Name="load_conditions.vi" Type="VI" URL="../sub_VIs/QC9530_delay_generators/load_conditions.vi"/>
				<Item Name="save_conditions.vi" Type="VI" URL="../sub_VIs/QC9530_delay_generators/save_conditions.vi"/>
				<Item Name="us_to_s.vi" Type="VI" URL="../sub_VIs/QC9530_delay_generators/us_to_s.vi"/>
				<Item Name="write_loaded_vars_to_controls.vi" Type="VI" URL="../sub_VIs/QC9530_delay_generators/write_loaded_vars_to_controls.vi"/>
			</Item>
			<Item Name="Sumitomo_F70_drivers" Type="Folder">
				<Item Name="open_comms_Sumitomo_F70.vi" Type="VI" URL="../sub_VIs/Sumitomo_F70_drivers/open_comms_Sumitomo_F70.vi"/>
				<Item Name="write_to_Sumitomo_F70.vi" Type="VI" URL="../sub_VIs/Sumitomo_F70_drivers/write_to_Sumitomo_F70.vi"/>
			</Item>
		</Item>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="instr.lib" Type="Folder">
				...
				<Item Name="Quantum Composers 9000 Series.lvlib" Type="Library" URL="/&lt;instrlib&gt;/Quantum Composers 9000 Series/Quantum Composers 9000 Series.lvlib"/>
			</Item>
